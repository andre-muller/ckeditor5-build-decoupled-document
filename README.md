...
This repository presents a CKEditor 5 editor build using Base 64 Connector to images
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `bj1kk3w12v3h-pix1pmxatckl`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
